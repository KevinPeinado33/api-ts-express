...
router.get('/:numPlaca', index_1.validarJWT, (0, index_1.tieneRole)('ADMIN_ROLE', 'INTEGRANTE'), clientes_1.getClienteByNumPlaca);
router.get('/:id', index_1.validarJWT, (0, index_1.tieneRole)('ADMIN_ROLE', 'INTEGRANTE'), clientes_1.getCliente);
router.post('/', index_1.validarJWT, (0, index_1.tieneRole)('ADMIN_ROLE', 'INTEGRANTE'), clientes_1.postCliente);
